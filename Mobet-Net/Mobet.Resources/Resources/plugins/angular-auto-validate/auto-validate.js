...
(function (angular) {
    ...
    angular.module('angular.autovalidate', []);
}(angular));
        ...
        .provider('validator', [
            function () {
                var elementStateModifiers = {},
                    enableValidElementStyling = false,
                ...
                var reset = function (el) {
                    ...
                    makeValid = function (el) {
                        ...
                        if (frmGroupEl) {
                            ...
                            frmGroupEl.addClass('has-success ' + (inputGroupEl.length > 0 ? '' : ''));
                    ...
                    makeInvalid = function (el, errorMsg) {
                        var frmGroupEl = findFormGroupElement(el),
                            helpTextEl = angular.element('<span class="help-block has-error error-msg" data-toggle="tooltip"  data-container="body" data-placement="right" title="" data-original-title="' + errorMsg + '">' + ' * ' + '</span>'),
                            inputGroupEl;

                        if (frmGroupEl) {
                            reset(frmGroupEl);
                            inputGroupEl = findInputGroupElement(frmGroupEl[0]);
                            frmGroupEl.addClass('has-error ' + (inputGroupEl.length > 0 ? '' : ''));
                        ...
                        $(helpTextEl).tooltip({ 'container': helpTextEl });
                    },
...
(function (angular) {
     ...
     */
    angular.module('angular.autovalidate').factory('debounce', [
        '$timeout',
        function ($timeout) {
...
(function (String, angular) {
    ...
    angular.autoValidate.errorMessages['zh-cn'] = {
        "defaultMsg": "\u6b64\u9879\u4e0d\u80fd\u4e3a\u7a7a",
        "email": "\u8bf7\u8f93\u5165\u6709\u6548\u7684\u90ae\u4ef6\u5730\u5740",
        ...
        "required": "\u6b64\u9879\u4e0d\u80fd\u4e3a\u7a7a",
        "date": "\u8bf7\u8f93\u5165\u6709\u6548\u7684\u65e5\u671f",
        "pattern": "\u8bf7\u6309\u7167\u4ee5\u4e0b\u683c\u5f0f{0}\u8f93\u5165",
        "number": "\u8bf7\u8f93\u5165\u6570\u5b57",
        "url": "\u8bf7\u8f93\u5165\u4e00\u4e2a\u6709\u6548\u7f51\u5740\u4f8b\u5982:http(s)://www.google.com"
    };
        ...
        .factory('defaultErrorMessageResolver', [
            ...
            function ($q, $http) {
                var currentCulture = 'zh-cn',
                    ...
                    i18nFileRootPath = '/resources/plugins/angular-auto-validate/lang',

                    cultureRetrievalPromise,

                    loadRemoteCulture = function (culture) {
                        cultureRetrievalPromise = $http.get('{0}/auto-validate_{1}.json'.format(i18nFileRootPath, culture.toLowerCase()));
...
(function (angular) {
    ...
    angular.module('angular.autovalidate').directive('form', [
        'validator',
        function (validator) {
            return {
                restrict: 'E',
    ...
    angular.module('angular.autovalidate').directive('ngForm', [
        'validator',
        function (validator) {
            return {
                restrict: 'EA',
...
(function (angular) {
    ...
    angular.module('angular.autovalidate').directive('registerCustomFormControl', [
        function () {
...
(function (angular) {
    ...
    angular.module('angular.autovalidate').config(ProviderFn);
}(angular));

(function (angular) {
    'use strict';

    angular.module('angular.autovalidate').config(['$provide',
        function ($provide) {
