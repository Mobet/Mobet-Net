...
namespace Mobet.GlobalSettings.Store
{
    /// <summary>
    ...
    public class SimpleGlobalSettingStore : IGlobalSettingStore
    {
        ...
        {
            return Task.FromResult(new GlobalSetting { Name = name, Value = ConfigurationManager.AppSettings[name] });
        }
        ...
        public Task<List<GlobalSetting>> GetAllSettingsAsync()
        {
            ...
            {
                settings.Add(new GlobalSetting { Name = key, Value = ConfigurationManager.AppSettings[key] });
            }
