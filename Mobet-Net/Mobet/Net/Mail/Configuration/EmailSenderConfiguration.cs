...
using Mobet.GlobalSettings.Extensions;
using System;
...
namespace Mobet.Net.Mail.Configuration
{
    /// <summary>
    /// Implementation of <see cref="IEmailSettingConfiguration"/> that reads settings
    /// from <see cref="IGlobalSettingManager"/>.
    /// </summary>
    public class EmailSettingConfiguration : IEmailSettingConfiguration, IDependency
    {
