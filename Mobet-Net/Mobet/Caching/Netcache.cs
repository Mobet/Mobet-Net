...
namespace Mobet.Caching
{
    public class Netcache : ICache, ISingletonDependency
    {
        ...
        /// 获取缓存
        /// </summary>
        T ICache.Get<T>(string key, Func<T> invoker)
        {
            var obj = provider.Get(key);
        ...
        /// <returns></returns>
        IDictionary<string, object> ICache.MultiGet(IEnumerable<string> keys)
        {
        ...
        /// <param name="keys"></param>
        /// <returns></returns>
        IEnumerable<T> ICache.MultiGet<T>(IEnumerable<string> keys)
        {
        ...
        /// <returns></returns>
        IEnumerable<T> ICache.MultiGet<T>(IEnumerable<string> keys, Func<IEnumerable<string>, IEnumerable<T>> invoker)
        {
        ...
        /// 失效条件：到达了失效时间
        /// </summary>
        void ICache.Set(string key, object value, DateTime invalidatedTime)
        {
            Set(
                key,
                value,
        ...
        /// 失效条件：到达了失效时间
        /// </summary>
        void ICache.Set(string key, object value, TimeSpan invalidatedSpan)
        {
            Set(
                key,
                value,
        ...
        T ICache.Modify<T>(string key, Func<T, T> invoker)
        {
        ...
        /// <param name="key"></param>
        /// <param name="invoker"></param>
        T ICache.Modify<T>(string key, Func<T, T> invoker, DateTime expireAt)
        {
        ...
        /// <param name="key"></param>
        /// <param name="invoker"></param>
        T ICache.Modify<T>(string key, Func<T, T> invoker, TimeSpan validFor)
        {
        ...
        /// </summary>
        T ICache.Retrive<T>(string key, Func<T> invoker)
        {
            return Retrive<T>(
                key,
                invoker,
        ...
        /// 失效条件：到达了失效时间
        /// </summary>
        T ICache.Retrive<T>(string key, Func<T> invoker, DateTime invaliddatedTime)
        {
            return Retrive<T>(
                key,
                invoker,
        ...
        /// 失效条件：到达了失效时间
        /// </summary>
        T ICache.Retrive<T>(string key, Func<T> invoker, TimeSpan invalidatedSpan)
        {
            return Retrive<T>(
                key,
                invoker,
        ...
        /// 延长缓存寿命
        /// </summary>
        T ICache.Lengthen<T>(string key, Func<T, Tuple<T, bool>> lengthenInvoker, Func<T> initInvoker, DateTime expireAt)
        {
        ...
        /// 延长缓存寿命
        /// </summary>
        T ICache.Lengthen<T>(string key, Func<T, Tuple<T, bool>> lengthenInvoker, Func<T> initInvoker, TimeSpan validFor)
        {
            throw new NotImplementedException();
        }
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Increment(string key, int delta)
        {
            Increment(
                key,
                null,
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Increment(string key, int delta, DateTime expiresAt)
        {
            Increment(
                key,
                null,
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Increment(string key, int delta, TimeSpan validFor)
        {
            Increment(
                key,
                null,
        ...
        /// </summary>
        void ICache.Increment(string key, int defaultValue, int delta)
        {
            Increment(
                key,
                defaultValue,
        ...
        /// 提供默认值，如果key值不存在，则插入默认值
        /// </summary>
        void ICache.Increment(string key, int defaultValue, int delta, DateTime expiresAt)
        {
            Increment(
                key,
                defaultValue,
        ...
        /// 提供默认值，如果key值不存在，则插入默认值
        /// </summary>
        void ICache.Increment(string key, int defaultValue, int delta, TimeSpan validFor)
        {
            Increment(
                key,
                defaultValue,
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Decrement(string key, int delta)
        {
            Decrement(
                key,
                null,
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Decrement(string key, int delta, DateTime expiresAt)
        {
            Decrement(
                key,
                null,
        ...
        /// 只有当key存在时，才进行计数
        /// </summary>
        void ICache.Decrement(string key, int delta, TimeSpan validFor)
        {
            Decrement(
                key,
                null,
        ...
        /// 提供默认值，如果key值不存在，则插入默认值
        /// </summary>
        void ICache.Decrement(string key, int defaultValue, int delta)
        {
            Decrement(
                key,
                defaultValue,
        ...
        /// 提供默认值，如果key值不存在，则插入默认值
        /// </summary>
        void ICache.Decrement(string key, int defaultValue, int delta, DateTime expiresAt)
        {
            Decrement(
                key,
                defaultValue,
        ...
        /// 提供默认值，如果key值不存在，则插入默认值
        /// </summary>
        void ICache.Decrement(string key, int defaultValue, int delta, TimeSpan validFor)
        {
            Decrement(
                key,
                defaultValue,
